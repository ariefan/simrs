...
<div class="inv-item-master-form">
    ...
    <?= $form->field($model, 'fornas_st')->widget(Select2::classname(), [
        'data' =>  [0=>"TIDAK",1=>"YA"],
        'options' => ['placeholder' => 'Fornas'],
        'pluginOptions' => [
            'allowClear' => true
        ],
    ]); ?>
    <?= $form->field($model, 'forrsu_st')->widget(Select2::classname(), [
        'data' =>  [0=>"TIDAK",1=>"YA"],
        'options' => ['placeholder' => 'Forrsu'],
        'pluginOptions' => [
            'allowClear' => true
        ],
    ]); ?>
