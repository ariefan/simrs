        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($model){
                    return ($model->medunit_cd=='')?'RAWAT INAP': $model->unit->medunit_nm;
                },
            ],
            [
            ...
            ['class' => 'yii\grid\ActionColumn',
             ...
             'buttons' => [
                'bayar' => function($url,$model) {
                    ...
                    return Html::a('Bayar',['bayar/create','id'=>utf8_encode(Yii::$app->security->encryptByKey( $model->kunjungan_id, Yii::$app->params['kunciInggris']))],
                        ['class'=>'btn dark btn-sm btn-outline sbold uppercase',
                            'title' => 'Bayar','target' => '_blank']);
                }, 
                'view' => function($url,$model) {
                    return (isset($model->bayar[0]->is_complete) && $model->bayar[0]->is_complete) ? 
                     Html::button('Lihat', [
