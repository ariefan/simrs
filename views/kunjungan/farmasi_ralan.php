...
$this->title = 'Farmasi Rawat Jalan';
             ...
             'buttons' => [
                ...
                'view' => function($url,$model) {
                    ...
                    return Html::button('Lihat', [
                            'value'=>Url::to(['rekam-medis/cetak-resep','id'=>utf8_encode(Yii::$app->security->encryptByKey( $model->rekamMedis[0]->rm_id, Yii::$app->params['kunciInggris'] )),'asal'=>'kunjungan/farmasi']),
