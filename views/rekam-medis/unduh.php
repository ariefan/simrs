...
<table class="table table-bordered">
    <tbody>
        ...
        <tr>
            ...
            <td><?= $pasien->nama ?> (<?= !(empty($pasien->tanggal_lahir)) ? $pasien->getAge($pasien->tanggal_lahir) : 0 ?> Tahun) </td>
        </tr>
...
<?php endforeach; ?>
    ...
    <tr height="100">
        <td align="center"><strong>(<?= ucwords($model->user->dokter->nama) ?>)</strong></td>
    </tr>
</table>
