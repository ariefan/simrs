...
<div class="tarif-general-form">
    <?php $form = ActiveForm::begin(); ?>

    <?php 
        $model->tarif_general_id = $model->idInsert; 

        echo $form->field($model, 'tarif_general_id')->textInput(['maxlength' => true]);
    ?>

    <?= $form->field($model, 'tarif_nm')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'auto_add')->widget(Select2::classname(), [
        'data' =>  ["1"=>"YA", "0"=>"TIDAK"],
        'options' => ['placeholder' => 'auto_add'],
        'pluginOptions' => [
            'allowClear' => true
        ],
    ]); ?>

    <?= $form->field($model, 'medical_tp')->textInput(['maxlength' => true]) ?>
