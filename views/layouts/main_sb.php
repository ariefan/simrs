...
<?php $this->beginBody() ?>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <?php if(!isset($menu_child[$k])): ?>
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="<?= Url::to([$v['route']]) ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse<?= $k ?>" aria-expanded="true" aria-controls="collapse<?= $k ?>">
          <i class="fas fa-fw fa-<?= $v['icon'] ?>"></i>
          <span><?= $v['nama'] ?></span>
        </a>
        <div id="collapse<?= $k ?>" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <!-- <h6 class="collapse-header">Custom Components:</h6> -->
            <?php foreach ($menu_child[$k]['nama'] as $key => $nama_menu): ?>
            <a class="collapse-item" href="<?= Url::to([$menu_child[$k]['route'][$key]]) ?>"><?= $nama_menu ?></a>
            <?php endforeach; ?>
          </div>
        </div>
      </li>
