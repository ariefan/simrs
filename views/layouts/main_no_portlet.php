                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user dropdown-light">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    ...
                                    <?= Html::img('@web/img/DR-avatar.png',['class'=>'img-circle']) ?>
                                    </a>
            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="nav-item">
                            <?= isset($menu_child[$menu_id]) ? '<a href="javascript:;" class="nav-link nav-toggle"><i class="fa fa-'.$menu_value['icon'].'"></i><span class="title">'.$menu_value['nama'].'</span><span class="arrow open"></span></a>' : Html::a('<i class="fa fa-'.$menu_value['icon'].'"></i><span class="title">'.$menu_value['nama'].'</span>',Url::to([$menu_value['route']])) ?>
