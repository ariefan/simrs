                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if(empty($val['catatan'])) {
                                            echo Html::a('<span class="fa fa-stethoscope"></span> Proses', Url::to(['rm-lab/create','id'=>$val['kunjungan_id']]), [
                                                'title' => Yii::t('yii', 'Proses'),
                                                'class' => 'btn red btn-sm btn-outline sbold uppercase',
                                            ]);
                                        } else {
                                            echo Html::a('<span class="fa fa-stethoscope"></span> Update', Url::to(['rm-lab/create','id'=>$val['kunjungan_id']]), [
