...
<div class="bayar-form">
    ...
    <div class="row static-info">
        ...
        <div class="col-md-6 name">
            <?php 
                echo $kunjungan['mr']."<br/>";
                echo "<strong>".$kunjungan['mr0']['nama']."</strong><br/>";
                echo $kunjungan['mr0']['alamat']."<br/>";
                echo $kunjungan['mr0']['jk']."<br/>";
                echo $rm_model->getAge($kunjungan['mr0']['tanggal_lahir'])." Tahun";
            ?>
        </div>
    </div>
    ...
    <div class="row static-info">
        ...
        <div class="col-md-5 value bayar_total">Rp <?= number_format($val['tarif'],0,'','.') ?></div>
        <?php $subtotal += $val['tarif'];  ?>
        <?php endforeach; ?>
    </div>
    ...
    <div class="row static-info">
        ...
        <div class="col-md-1 value"></div>
        <div class="col-md-5 name"><?= $val['nama_merk'] ?></div>
