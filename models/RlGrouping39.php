...
/**
 * This is the model class for table "rl_grouping_39".
 *
 * @property string $rl_ref_39_no
 * @property string $tindakan_cd
 *
 * @property Tindakan $tindakanCd
 */
class RlGrouping39 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['rl_ref_39_no', 'tindakan_cd'], 'required'],
            [['rl_ref_39_no'], 'string', 'max' => 30],
