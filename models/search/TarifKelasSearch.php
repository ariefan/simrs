...
/**
 * TarifKelasSearch represents the model behind the search form about `app\models\TarifKelas`.
 */
class TarifKelasSearch extends TarifKelas
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['seq_no'], 'integer'],
            [['insurance_cd', 'kelas_cd', 'account_cd', 'modi_id', 'modi_datetime'], 'safe'],
            [['tarif'], 'number'],
        ];
    }
